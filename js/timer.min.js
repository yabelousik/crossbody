(function(){var A=function(g,m){return function(){return g.apply(m,arguments)}},B=[].indexOf||function(g){for(var m=0,y=this.length;m<y;m++)if(m in this&&this[m]===g)return m;return-1},D={}.hasOwnProperty;this.flipchartCss='<link href="timer.min.css@v=3" rel="stylesheet" type="text/css">';this.MegaTimer=function(){function g(a,b){this.plateTick=A(this.plateTick,this);this.circleTick=A(this.circleTick,this);this.newTime=A(this.newTime,this);this.id=a;this.params=b;this.timerElements=
this.cloneObject(C);this.tickEvent=[];m(window,"load",function(a){return function(){return a.run()}}(this));m(window,"focus",function(a){return function(){a.initType();return a.newTime(!0)}}(this))}var m,y,z,C;y=null;z=[];C={secundes:{max:60,min:0,text:"S",value:0,view:!0,updated:!1},minutes:{max:60,min:0,text:"M",value:0,view:!0,updated:!1},hours:{max:24,min:0,text:"H",value:0,view:!0,updated:!1},days:{max:1E3,
